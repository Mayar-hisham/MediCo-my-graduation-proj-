...
<body>
    ...
    <div class="cont1">
        ...
        <br><br><br><br><Br>
        <div class="conent">
            <form method="POST" enctype='multipart/form-data' style="margin-top: 0px; margin-bottom: 50px; margin-left:140px">
                ...
                <input disabled value="<?php echo $_date ?>" id="time of accepting the order" name="date of accepting the order" placeholder="Enter time of accepting the order...">

                <label for="time">Date of accepting the order</label>
                <input disabled name="time" value="<?php echo $_time ?>" id="time of accepting the order" placeholder="Enter time of accepting the order...">

                <label for="name">Estimated delivery time</label>
                <input type="time" name="dtime" id="estimated delivery day" placeholder="Enter time of accepting the order...">


                <label for="name">Estimated delivery day</label>
                <input type="date" name="dday" id="estimated delivery day" placeholder="Enter time of accepting the order...">



                <label for="name">Delivery man phone number</label>
                <input type="text" id="delivery man phone number" name="dphone" placeholder="Enter delivery man phone number...">

                <label for="name">Type a message to your customer</label>
                <input name="message" type="text" id="type a message to your customer" placeholder="Enter type a message to your customer...">
